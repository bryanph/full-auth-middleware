...
exports.create = function(req, res, next){
    ...
    workflow.on('duplicateStatusCheck', function() {
        req.app.db.models.Status.findById(slugify(req.body.pivot +' '+ req.body.name)).exec(function(err, status) {
            if (err) {
...
exports.update = function(req, res, next){
    ...
    workflow.on('validate', function() {
        ...
        // TODO: pivot seems to be removed from the api call - 2017-05-01
        // if (!req.body.pivot) {
